  ...
  return (
    <div className="overflow-x-hidden pt-20">
      ...
      <section className="grid grid-cols-1 lg:grid-cols-2 lg:min-h-[max(calc(100vh-80px),800px)]">
        ...
        {/* 1. Intro Section */}
        <div className="bg-[#141410] text-white p-8 pt-20 md:p-16 flex flex-col lg:justify-center order-1 lg:col-start-1 lg:row-start-1">
          <div className="max-w-xl mx-auto lg:mx-0 lg:ml-auto w-full">
            <RevealOnScroll>
              ...
              <h1 className="font-barlow font-black text-[clamp(3rem,6vw,5.5rem)] uppercase leading-[0.88] tracking-[-0.01em] mb-8">
                Say <span className="text-rust">hello.</span>
              </h1>
              <p className="font-dm-mono text-white/70 text-base mb-12 leading-[1.7]">
              ...
              <div className="inline-flex items-center gap-3 bg-[#1A1A14] border border-white/10 px-4 py-2">
        ...
        {/* 2. Form Section */}
        <div className="bg-[#0D0D0A] text-white p-8 md:p-16 flex flex-col lg:justify-center relative order-2 lg:col-start-2 lg:row-start-1 lg:row-span-2">
          <div className="max-w-xl mx-auto lg:mx-0 lg:mr-auto w-full">
            <RevealOnScroll>
              <div className="mb-12">
                <h2 className="font-barlow font-black text-4xl md:text-5xl uppercase leading-[0.9] mb-4">
                  Send a <span className="text-rust">message.</span>
                </h2>
              ...
              <form onSubmit={handleSubmit} className="flex flex-col gap-6">
                <div className="grid grid-cols-1 sm:grid-cols-2 gap-6">
                  <div className="flex flex-col gap-2">
                    ...
                    <input
                      ...
                      id="firstName"
                      name="firstName"
                      className="bg-[#1A1A14] border border-white/10 rounded-none px-4 py-3 text-white focus:outline-none focus:border-rust transition-colors font-dm-mono text-sm"
                      placeholder="Jane"
                    />
                  </div>
                  <div className="flex flex-col gap-2">
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <select
                    ...
                    name="subject"
                    required
                    className="bg-[#1A1A14] border border-white/10 rounded-none px-4 py-3 text-white focus:outline-none focus:border-rust transition-colors font-dm-mono text-sm appearance-none cursor-pointer"
                  >
                ...
                <div className="flex flex-col gap-2">
                  ...
                  <textarea
                    ...
                    id="message"
                    name="message"
                    className="bg-[#1A1A14] border border-white/10 rounded-none px-4 py-3 text-white focus:outline-none focus:border-rust transition-colors font-dm-mono text-sm min-h-[140px] resize-y"
                ...
                <div className="flex flex-col gap-2">
                  <button
                    type="submit"
                    disabled={isLoading}
                    className="bg-rust text-white font-dm-mono text-xs uppercase tracking-[0.2em] py-4 px-8 hover:bg-terracotta transition-colors flex justify-between items-center group disabled:opacity-70 disabled:cursor-not-allowed"
                  >
        ...
        {/* 3. Links Section */}
        <div className="bg-[#141410] text-white p-8 pt-0 pb-20 md:p-16 flex flex-col lg:justify-center order-3 lg:col-start-1 lg:row-start-2">
          <div className="max-w-xl mx-auto lg:mx-0 lg:ml-auto w-full">
                  ...
                  >
                    ...
                    <div className="flex items-center gap-6 transform group-hover:translate-x-4 transition-transform duration-300 pl-2">
                      ...
                      <div className="flex flex-col sm:flex-row sm:items-center gap-1 sm:gap-4">
                        ...
                        <span className="font-dm-mono text-white/50">
                          {social.handle}
                        </span>
                      </div>
                    </div>
      ...
      <section className="bg-[#141410] py-24 px-6 md:px-12 border-t border-white/10">
          ...
          <div className="text-center mb-16">
            <RevealOnScroll>
              ...
              <h2 className="font-barlow font-black text-4xl md:text-5xl text-white uppercase leading-[0.9] mt-6">
                Frequently asked <span className="text-rust">questions.</span>
              </h2>
            </RevealOnScroll>
          </div>
            ...
            {FAQS.map((faq, idx) => (
              <RevealOnScroll key={idx} delay={idx * 50}>
                <div className="border-b border-white/10 relative">
                  ...
                  >
                    <h3 className={`font-barlow font-bold text-xl md:text-2xl uppercase transition-colors ${openFaqIndex === idx ? "text-rust" : "text-white group-hover:text-rust/70"}`}>
                      {faq.question}
                    </h3>
                    <div className="flex shrink-0 ml-6 relative w-6 h-6 items-center justify-center">
                      <div className={`absolute w-[2px] h-6 bg-white transition-all duration-500 ease-in-out ${openFaqIndex === idx ? "rotate-90 bg-rust opacity-0" : "rotate-0"}`} />
                      <div className={`absolute h-[2px] w-6 bg-white transition-all duration-500 ease-in-out ${openFaqIndex === idx ? "rotate-[180deg] bg-rust" : "rotate-0"}`} />
                    </div>
                  </button>
                  ...
                  >
                    <p className="font-dm-mono text-white/70 text-[0.9rem] max-w-2xl leading-relaxed">
                      {faq.answer}
                    </p>
                  </div>
                </div>
