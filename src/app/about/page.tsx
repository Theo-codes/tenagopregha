...
export default function AboutPage() {
  ...
  return (
    <div className="pt-20">
      {/* SECTION 1: Page Hero */}
      <section className="relative bg-[#141410] text-white pt-40 md:pt-40 pb-20 px-8 md:px-[4rem] min-h-[70vh] flex flex-col justify-center overflow-hidden">
        <div className="max-w-[1100px] mx-auto w-full z-10 grid grid-cols-1 md:grid-cols-2 gap-12 items-center">
          ...
          <div className="flex flex-col">
            <RevealOnScroll>
              ...
              <h1 className="font-barlow font-black text-[clamp(3.5rem,7vw,6.5rem)] uppercase leading-[0.88] tracking-[-0.01em]">
                About <span className="text-rust">Tena.</span>
              </h1>
            </RevealOnScroll>
          </div>
          ...
          <div className="flex flex-col mt-8 md:mt-0">
            <RevealOnScroll delay={100}>
              <p className="font-dm-mono text-white/70 text-base md:text-lg mb-8 leading-[1.7]">
            ...
            <RevealOnScroll delay={200}>
              <div className="flex flex-wrap gap-3">
                {["Product Designer", "UI/UX", "Frontend Dev", "Next.js", "Figma", "Lagos, Nigeria", "CS Graduate"].map((tag) => (
                  <span
                    key={tag}
                    className="font-dm-mono text-xs uppercase tracking-wider text-rust border border-rust/30 px-3 py-1.5 bg-rust/5"
                  >
                    {tag}
                  </span>
                ))}
        ...
        <div className="absolute bottom-[-10%] right-[-5%] pointer-events-none select-none overflow-hidden opacity-[0.06]">
          <span
            className="font-barlow font-black uppercase text-[15rem] md:text-[25rem] leading-none"
      ...
      <section className="bg-[#0D0D0A] py-24 px-6 md:px-12 relative">
        <div className="max-w-[1100px] mx-auto w-full grid grid-cols-1 md:grid-cols-12 gap-12 relative">
              ...
              {[
                ...
                <a
                  ...
                  className={`font-dm-mono text-sm uppercase tracking-widest transition-all duration-300 md:pl-4 md:border-l-2 py-1 ${activeHash === link.id
                    ...
                    : "text-white/40 hover:text-white md:border-transparent"
                    }`}
                >
                  {link.label}
                </a>
          ...
          <div className="md:col-span-8 lg:col-span-9 space-y-32">
            ...
            <div id="origin" className="scroll-mt-36">
              <RevealOnScroll>
                <h3 className="font-barlow font-bold text-3xl text-white uppercase leading-[0.9] mb-6">
                  Where it <span className="text-rust">started</span>.
                </h3>
                <div className="font-dm-mono text-white/70 text-[0.9rem] leading-[1.7] space-y-6 max-w-2xl">
                  <p>
            ...
            <div id="approach" className="scroll-mt-36">
              <RevealOnScroll>
                <h3 className="font-barlow font-bold text-3xl text-white uppercase leading-[0.9] mb-6">
                  How I <span className="text-rust">build</span>.
                </h3>
                <div className="font-dm-mono text-white/70 text-[0.9rem] leading-[1.7] space-y-6 max-w-2xl">
                  <p>
            ...
            <div id="now" className="scroll-mt-36">
              <RevealOnScroll>
                <h3 className="font-barlow font-bold text-3xl text-white uppercase leading-[0.9] mb-6">
                  What I&apos;m doing <span className="text-rust">now</span>.
                </h3>
                <div className="font-dm-mono text-white/70 text-[0.9rem] leading-[1.7] space-y-6 max-w-2xl">
                  <p>
      ...
      {/* SECTION 3: Skills */}
      <section className="bg-[#141410] py-24 px-6 md:px-12">
        <div className="max-w-[1100px] mx-auto w-full">
          <RevealOnScroll>
            <SectionLabel text="Skills & tools" />
            <h2 className="font-barlow font-black text-4xl md:text-5xl text-white uppercase leading-[0.9] mt-6 mb-16">
              The <span className="text-rust">toolkit.</span>
            </h2>
          </RevealOnScroll>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 lg:grid-cols-3 gap-[2px] bg-white/5 border border-white/10">
            {SKILLS.map((skill, idx) => (
              <RevealOnScroll key={skill.title} delay={idx * 50}>
                <div className="group relative bg-[#1A1A14] p-8 h-full min-h-[220px] transition-colors hover:bg-[#222218] flex flex-col justify-between overflow-hidden">
                  <div className="text-3xl mb-4">{skill.icon}</div>
                  <div>
                    <h4 className="font-dm-mono text-sm uppercase tracking-widest text-rust mb-3">
                      {skill.title}
                    </h4>
                    <p className="font-dm-mono text-white/70 text-[0.875rem] leading-relaxed">
                      {skill.desc}
                    </p>
                  </div>
          ...
          <div className="mb-16">
            <RevealOnScroll>
              ...
              <h2 className="font-barlow font-black text-4xl md:text-5xl text-white uppercase leading-[0.9] mt-6">
                Principles I <span className="text-rust">build</span> by.
              </h2>
            </RevealOnScroll>
          </div>
          ...
          <div className="grid grid-cols-1 md:grid-cols-2 gap-6">
            {VALUES.map((val, idx) => (
              <RevealOnScroll key={idx} delay={idx * 100}>
                <div className="relative bg-[#141410] border border-white/10 p-8 md:p-12 h-full overflow-hidden group">
                  ...
                  <p className="font-dm-mono text-white/70 text-[0.9rem] leading-relaxed z-10 relative">
                    {val.desc}
                  </p>
                </div>
              </RevealOnScroll>
